...
/**
 * Initial TransKnight loadout, decoded from records #2/#19/#23/#3/#5.
 * The order intentionally keeps the three attacks before the two buffs.
 */
